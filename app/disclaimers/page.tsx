  ...
  return (
    <Shell>
      <Container className="space-y-12 py-12 sm:py-16">
        <PageHeader eyebrow="Disclaimers" title="Career guidance needs clear boundaries." copy="KRAFT is a learning centre. Use it to prepare and verify, not as a guarantee of outcomes." />
        <div className="grid gap-4 md:grid-cols-2">
          {warnings.map((warning) => (
            <div key={warning.title} className="rounded-3xl border border-amber-200 bg-amber-50 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-amber-900">{warning.copy}</p>
            </div>
          ))}
        </div>

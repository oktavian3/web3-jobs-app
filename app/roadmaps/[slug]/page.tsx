        ...
        <section>
          ...
          <ol className="mt-6 space-y-4">
            {detail.milestones.map((milestone, i) => (
              <li key={i} className="rounded-3xl border border-border bg-white p-5 sm:p-6">
                <div className="flex items-start gap-4">
                  <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-ink text-sm font-extrabold text-white" aria-hidden="true">{i + 1}</span>
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg font-extrabold tracking-tight text-ink">{milestone.title}</h3>
        ...
        <section className="rounded-3xl border border-blue-100 bg-blue-50 p-5 sm:p-6">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-blue-900">{detail.decisionPoint}</p>
            </div>
          </div>
        </section>

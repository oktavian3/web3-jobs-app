...
export const textareaClass =
  "w-full rounded-2xl border border-border bg-soft px-4 py-3 text-sm font-normal leading-6 text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600";

export const labelClass = "mb-1.5 block text-xs font-bold uppercase tracking-[0.08em] text-muted";

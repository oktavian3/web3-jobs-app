...
export default function HeroProductPreview() {
  ...
  const cardClass =
    "group relative flex flex-col overflow-hidden rounded-3xl border border-white/45 bg-white/92 p-4 text-left shadow-blue backdrop-blur transition duration-300 hover:-translate-y-1.5 hover:border-white hover:shadow-[0_24px_70px_rgba(20,107,255,0.24)] focus-visible:-translate-y-1.5";
      ...
      <div className="relative z-10 grid gap-4 lg:grid-cols-4">
        {role && (
          <Link href={`/roles/${role.slug}`} className={`${cardClass} pixel-accent`}>
            ...
            <span className="mt-4 inline-flex items-center gap-1 text-xs font-extrabold text-blue-700">
